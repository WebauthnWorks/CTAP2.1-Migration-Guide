...
You will need pinUvAuthParam. Explained at # obtaining pinUvAuthParam 
...
We merge the arrayBuffers using _0x0d_ as the authenticator cmd, **authenticatorConfig** and _0x02_ as the **subCommand**. SubcommandParams not defined for 0x02 subCommand.
